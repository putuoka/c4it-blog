...
![OpenAPI file structure](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/openapi-file.png "OpenAPI file structure")
...
![Where to find the link to the JSON file](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/swagger-file-link.png "Where to find the link to the JSON file")
...
![Add > Service Reference](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/add-service-reference-menu.png "Service Reference in menu")

Here you can add references to _OpenAPIs_, _gRPC_, and other external services.

Now, click on _Add_ under the OpenAPI section.

![OpenAPI > Add](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/add-service-reference.png "OpenAPI wizard")
...
![Select OpenAPI JSON file location](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/add-openapi-file.png "Select OpenAPI JSON file location")
...
![Where to find generated code](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/generate-code.png "Where to find generated code")
...
![API routes that overlap](https://res.cloudinary.com/bellons/image/upload/t_content-image/Code4IT/Articles/2020/OpenApi-Code-Generation/api-endpoints.png "API routes that overlap")
